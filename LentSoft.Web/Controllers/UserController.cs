...
public class UserController : Controller
{
    ...
    public async Task<IActionResult> CreateClient(ClientFormViewModel model)
    {
        ...
        try
        {
            ...
            var isAutoGenerated = string.IsNullOrWhiteSpace(model.Password);
            var pass = isAutoGenerated
            ...
            TempData["SuccessMessage"] = isAutoGenerated
                ? $"Cliente creado exitosamente. Contraseña asignada: {pass}"
