...
public class LentSoftDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HistorialClinico>().HasData(
            new HistorialClinico
            {
                ...
                Diagnostico = "Miopía leve OD -1.25 OI -1.50",
                Tratamiento = "Lentes correctivos",
                Observaciones = "Paciente refiere fatiga visual al trabajar frente al computador."
            }
        );

        // Sample ExamenVisual
        modelBuilder.Entity<ExamenVisual>().HasData(
            new ExamenVisual
            {
                Id = 1,
                PacienteId = 2,
                OptometraId = 3,
                Fecha = new DateTime(2026, 6, 1, 10, 0, 0, DateTimeKind.Utc),
                TipoExamen = "Agudeza Visual",
                OjoDerecho = "20/25",
                OjoIzquierdo = "20/30",
                Resultado = "Requiere corrección óptica"
            }
        );

        // Sample FormulaOptica
        modelBuilder.Entity<FormulaOptica>().HasData(
            new FormulaOptica
            {
                Id = 1,
                PacienteId = 2,
                ...
                CilindroOI = "-0.75",
                EjeOI = "175°",
                Observaciones = "Uso permanente. Control en 6 meses."
            }
        );
    }
}
